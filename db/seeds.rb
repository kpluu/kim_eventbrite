...
12.times do
  u = User.create(email: ["frankyboss@yopmail.com", "catherinethpcode@yopmail.com", "gerardthpcode@yopmail.com", "jeanclaudethpcode@yopmail.com", "morganethpcode@yopmail.com", "michelthpcode@yopmail.com"].sample, password: Faker::Verb.simple_present, description: Faker::Movie.quote, first_name: Faker::Name.first_name, last_name: Faker::Name.last_name)
